...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    // Procurement
    fun getSuppliers(): String = procurement.getSuppliers()
    fun getSuppliersSearch(term: String): String = procurement.getSuppliersSearch(term)
    fun deleteSupplier(id: Int): String = procurement.deleteSupplier(id)
    fun deletePurchase(id: Int): String = procurement.deletePurchase(id)
    fun getSupplierItems(supplierId: Int): String = procurement.getSupplierItems(supplierId)
    fun saveSupplierItems(json: String): String = procurement.saveSupplierItems(json)
    fun saveSupplier(json: String): String = procurement.saveSupplier(json)
    fun savePurchase(json: String): String = procurement.savePurchase(json)
    fun receiveStock(): String = procurement.receiveStock()
    fun getAveragePurchasedMilkCogs(productId: Int): String = procurement.getAveragePurchasedMilkCogs(productId)
    fun getPurchase(id: String): String = procurement.getPurchase(id)
    fun getPurchaseById(id: Int): PurchaseHeader? = procurement.getPurchaseById(id)
    fun getPurchaseItemsByPurchaseId(purchaseId: Int): List<PurchaseItem1> = procurement.getPurchaseItemsByPurchaseId(purchaseId)
    fun getPurchaseItems(purchaseId: String): String = procurement.getPurchaseItems(purchaseId)
    fun getPurchaseStatus(): String = procurement.getPurchaseStatus()
    fun getPurchases(): String = procurement.getPurchases()
    fun getSupplierPurchaseSummariesThisMonth(): String = procurement.getSupplierPurchaseSummariesThisMonth()
    fun queryPurchaseByDateReport(start: String, end: String): String = procurement.queryPurchaseByDateReport(start, end)
    fun saveAssetPurchase(json: String): String = procurement.saveAssetPurchase(json)
    fun getPurchase(purchaseId: Int): String? = procurement.getPurchase(purchaseId)
    fun getPurchaseItems(purchaseId: Int): String = procurement.getPurchaseItems(purchaseId)

    // Inventory
    fun getAllUnits(): String = inventory.getAllUnits()
    fun saveUnit(json: String): String = inventory.saveUnit(json)
    fun deleteUnit(id: Int): String = inventory.deleteUnit(id)
    fun getUOMList(): String = inventory.getUOMList()
    fun getAllProducts(): String = inventory.getAllProducts()
    fun getSellableProducts(): String = inventory.getSellableProducts()
    fun getProduct(id: String): String = inventory.getProduct(id)
    fun saveProduct(json: String): String = inventory.saveProduct(json)
    fun deleteProduct(id: Int): Boolean = inventory.deleteProduct(id)
    fun getProductBaseUnit(productId: String): String = inventory.getProductBaseUnit(productId)
    fun getProductIdByCategory_pub(categoryName: String): Int = inventory.getProductIdByCategory(categoryName)
    fun getBaseUomId_pub(productId: Int): Int = inventory.getBaseUomId(productId)
    fun getConversionFactor_pub(fromUomId: Int, toUomId: Int): Double = inventory.getConversionFactor(fromUomId, toUomId)
    fun getAllConversions(): String = inventory.getAllConversions()
    fun saveConversion(json: String): String = inventory.saveConversion(json)
    fun deleteConversion(conversionId: Int): Boolean = inventory.deleteConversion(conversionId)
    fun getConversion(fromUnit: String, toUnit: String): String = inventory.getConversion(fromUnit, toUnit)
    fun getStock(productId: String, unitId: String): String = inventory.getStock(productId, unitId)
    fun saveStock(json: String): String = inventory.saveStock(json)
    fun saveStockOld(json: String): String = inventory.saveStockOld(json)
    fun saveStockPlain(productId: Int, quantity: Double, uomId: Int): Long = inventory.saveStockPlain(productId, quantity, uomId)
    fun deleteStockPlain(productId: Int, uomId: Int): Boolean = inventory.deleteStockPlain(productId, uomId)
    fun getRawStockSummary(): String = inventory.getRawStockSummary()
    fun getStockSummary(): String = inventory.getStockSummary()
    fun getStockHistory(): String = inventory.getStockHistory()
    fun saveConsumption(json: String): String = inventory.saveConsumption(json)
    fun recalibrateStock_delete(): String = inventory.recalibrateStock_delete()
    fun gatherNetQuantity(productId: Int): StockLevel = inventory.gatherNetQuantity(productId)
    fun calculateBaseUnitPrice(productId: Int): Double = inventory.calculateBaseUnitPrice(productId)

    // Production
    fun getMilkSummary(): String = production.getMilkSummary()
    fun fetchPurchasedMilkDetails(): List<PurchasedMilkDetail> = production.fetchPurchasedMilkDetails()
    fun saveMix(): String = production.saveMix()
    fun saveMilkProduction(json: String): String = production.saveMilkProduction(json)
    fun updateProducedSellableMilk() = production.updateProducedSellableMilk()
    fun getProducedMilkDetails(): List<ProducedMilkRecord> = production.getProducedMilkDetails()
    fun getAverageProducedMilkCogs(productId: Int): String = production.getAverageProducedMilkCogs(productId)
    fun getProductionExpenseSummaries(transactionType: String): List<ProductionExpenseSummary> = production.getProductionExpenseSummaries(transactionType)
    fun getProductionCostDetails(date: String): List<ReversalCostJournal> = production.getProductionCostDetails(date)
    fun markProductionExpensesAsExpensedtest() = production.markProductionExpensesAsExpensedtest()
    fun markExpensed(transactionType: String) = production.markExpensed(transactionType)
    fun recordProductionCostReversal() = production.recordProductionCostReversal()

    // Sales
    fun getAllSales(): String = sales.getAllSales()
    fun getSaleReport(fromDate: String, toDate: String): String = sales.getSaleReport(fromDate, toDate)
    fun getSalesPerMonthToDate(): String = sales.getSalesPerMonthToDate()
    fun getCustomerSalesSummariesThisMonth(): String = sales.getCustomerSalesSummariesThisMonth()
    fun saveSale(json: String): String = sales.saveSale(json)
    fun recordSale(batchId: Int, input: SaleInput): String = sales.recordSale(batchId, input)

    // Customer
    fun saveCustomer(json: String): String = customer.saveCustomer(json)
    fun getAllCustomers(): String = customer.getAllCustomers()
    fun getAllCustomersList(): List<CustomerDto> = customer.getAllCustomersList()
    fun searchCustomers(filter: String, classFilterId: Int?): String = customer.searchCustomers(filter, classFilterId)
    fun getCustomerLocations(customerId: Int): String = customer.getCustomerLocations(customerId)
    fun deleteCustomerLocation(id: Int) = customer.deleteCustomerLocation(id)
    fun deleteCustomerPhoto(id: Int) = customer.deleteCustomerPhoto(id)
    fun updateMapUrl(id: Int, url: String) = customer.updateMapUrl(id, url)
    fun updateCustomerLatLon(id: Int, lat: Double, lon: Double) = customer.updateCustomerLatLon(id, lat, lon)
    fun getCustomerPhotos(customerId: Int): String = customer.getCustomerPhotos(customerId)
    ...
    fun insertCustomerPhoto(customerId: Int, bytes: ByteArray, caption: String) = customer.insertCustomerPhoto(customerId, bytes, caption)
    fun isInvoiceExists(custId: Int, monthId: Int): Boolean = customer.isInvoiceExists(custId, monthId)
    fun getCustomerOpenPayments(customerId: String): String = customer.getCustomerOpenPayments(customerId)
    fun getOpenInvoices(): String = customer.getOpenInvoices()
    fun getPaidInvoices(): String = customer.getPaidInvoices()
    fun getInvoiceDetails(invoiceId: Int): String = customer.getInvoiceDetails(invoiceId)
    fun getCustomerOpenInvoices(customerId: Int): List<Map<String, Any>> = customer.getCustomerOpenInvoices(customerId)
    fun receiveCustomerPayment(customerId: Int, amount: Double, notes: String): Long = customer.receiveCustomerPayment(customerId, amount, notes)
    ...
    fun generateCustomerSalesInvoiceString(customerId: Int, monthId: Int): String = customer.generateCustomerSalesInvoiceString(customerId, monthId)

    // Expense
    fun getWorkers(): String = expense.getWorkers()
    fun saveLaborExpense(json: String): String = expense.saveLaborExpense(json)
    fun saveFuelExpense(json: String): String = expense.saveFuelExpense(json)
    fun insertDailyRentalAllocation(leaseId: Int, allocationDate: String, dailyAmt: Double, notes: String): Pair<Int, Boolean> = expense.insertDailyRentalAllocation(leaseId, allocationDate, dailyAmt, notes)

    // Account
    fun getAllAccountTypes(): String = account.getAllAccountTypes()
    fun deleteAccountType(id: Int): String = account.deleteAccountType(id)
    fun saveAccountType(json: String): String = account.saveAccountType(json)
    fun getAccountTypeById(id: Int): String = account.getAccountTypeById(id)
    fun getAllAccounts(): String = account.getAllAccounts()
    fun getAccountsDropDown(): String = account.getAccountsDropDown()
    fun getAccountById(id: Int): String = account.getAccountById(id)
    fun saveAccount(json: String): String = account.saveAccount(json)
    fun deleteAccount(id: Int): String = account.deleteAccount(id)
    fun getPostingAccounts(): List<ChartAccount> = account.getPostingAccounts()
    fun getTransactionTypes(): String = account.getTransactionTypes()
    fun getTxnTypeAccountMapping(typeId: Int): String? = account.getTxnTypeAccountMapping(typeId)

    // Journal
    fun getJournalEntries(): String = journal.getJournalEntries()
    fun saveJournalEntry(json: String): String = journal.saveJournalEntry(json)
    fun postJournalEntries(transactionId: Long) = journal.postJournalEntries(transactionId)
    ...
    ): String = financialReport.getProfitAndLoss(from, to)
    fun getJournalEntryReport(fromDate: String, toDate: String): String = financialReport.getJournalEntryReport(fromDate, toDate)
    fun getTransactionReport(fromDate: String, toDate: String): String = financialReport.getTransactionReport(fromDate, toDate)
    fun getTrialBalance(): String = financialReport.getTrialBalance()
    fun getBalanceSheet(asOfDate: String): String = financialReport.getBalanceSheet(asOfDate)
    fun getIncomeStatement(fromDate: String, toDate: String): String = financialReport.getIncomeStatement(fromDate, toDate)
    fun getCashFlow(fromDate: String, toDate: String): String = financialReport.getCashFlow(fromDate, toDate)
}
